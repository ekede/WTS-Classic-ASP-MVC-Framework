<%
'@title: Class_Ext_Verify
'@author: Gerrit van Kuipers
'@date: 2017-12-7
'@description: aspJSON Februari 2014 - Version 1.17 by 

Class Class_Ext_Verify
    
    Private sn_
	
	'@sn: 设置验证码session名
    Public Property Let sn(Value)
	    sn_= Value
	End Property

	'@output: 输出验证码图片
	Public Property Get output()
		If sn_ = "" Then sn_ = "verifycode"
